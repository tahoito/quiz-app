const sekaowaquestions = [
  ...
  {
    question: 'SEKAI NO OWARIのボーカルの名前は？',
  ...
  },
  {
    ...
    options: ['君の名は。', 'メアリと魔女の花', '天気の子', 'バケモノの子'],
    answer: 'メアリと魔女の花',
  },
  {
  ...
  {
    question: '「Love the warz」で何を愛せと言っている？',
    options: ['敵', '戦争', '未来', '人間'],
    answer: '戦争',
  },
  {
  ...
  },
  {
    ...
    options: ['自分たちの世界が一度終わったから', '世界を変えるため', '未来を信じて', '音楽で世界を救うため'],
